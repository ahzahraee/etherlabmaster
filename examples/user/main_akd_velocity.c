...
#include "cstruct_akd_velocity.h"

/* 						Application parameters						 */
// cyclic task period
#define period_sec	0
#define period_usec	1000
#define TASK_PERIODE	(period_sec + period_usec*1e-6)	// Seconds
#define TASK_FREQUENCY 1/TASK_PERIODE	// Hz
...
const static ec_pdo_entry_reg_t domain_0_regs[] = {
	    ...
	    { AKDPos, Kollmorgen_AKD, 0x60FF, 0, &offset.target_velocity },
...
void cyclic_task()
{
	...
	if (s_akd.operational) {
	    ...
	    /* write output */
	    EC_WRITE_S16( domains_pd[0] + offset.target_velocity, target_velocity );
